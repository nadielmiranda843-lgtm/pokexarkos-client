...
function init()
  ...
  g_keyboard.bindKeyPress('Tab', function() if isChatEnabled() then consoleTabBar:selectNextTab() end end, consolePanel)
...
function online()
  ...
  scheduleEvent(function()
    if not consoleTabBar or not defaultTab then return end
    local defaultTabByName = consoleTabBar:getTab(tr('Default'))
    if defaultTabByName then
      consoleTabBar:selectTab(defaultTabByName)
    elseif defaultTab.tabPanel then
      consoleTabBar:selectTab(defaultTab)
    end
  end, 500)
