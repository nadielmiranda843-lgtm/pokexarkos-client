...
local deathTexts = {
  regular = {text = 'Voce morreu.\nMas nao se desespere, os deuses trarao voce de volta\npara este mundo em troca de um pequeno sacrificio.\n\nBasta clicar em Ok para voltar a sua jornada!', height = 140, width = 0},
  unfair = {text = 'Voce morreu.\nMas nao se desespere, os deuses trarao voce de volta\npara este mundo em troca de um pequeno sacrificio.\n\nA penalidade de morte foi reduzida em %i%%\nporque esta foi uma luta injusta.\n\nBasta clicar em Ok para voltar a sua jornada!', height = 185, width = 0},
  blessed = {text = 'Voce morreu.\nMas nao se desespere, os deuses trarao voce de volta para este mundo.\n\nA penalidade de morte foi reduzida em 100%\nporque voce esta abencoado com a Bencao do Aventureiro.\n\nBasta clicar em Ok para voltar a sua jornada!', height = 170, width = 90}
}
